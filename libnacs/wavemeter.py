...
nacs_utils_new_wavemeter_parser = handle.nacs_utils.nacs_utils_new_wavemeter_parser
nacs_utils_new_wavemeter_parser.restype = ctypes.c_void_p
nacs_utils_new_wavemeter_parser.argtypes = [ctypes.c_double, ctypes.c_double]

nacs_utils_free_wavemeter_parser = handle.nacs_utils.nacs_utils_free_wavemeter_parser
nacs_utils_free_wavemeter_parser.restype = None
nacs_utils_free_wavemeter_parser.argtypes = [ctypes.c_void_p]
...
class WavemeterParser:
    def __init__(self, lo=0, hi=1.7976931348623157e308):
        self.hdl = nacs_utils_new_wavemeter_parser_withlim(lo, hi)
    ...
    def __del__(self):
        nacs_utils_free_wavemeter_parser(self.hdl)
